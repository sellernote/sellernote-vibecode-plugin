...
- **Rule**: [MUST] Files exceeding 10MB must use the 3-step Presigned URL pattern.
...
```
NestJS (Code-First)
  → OpenAPI Spec (JSON/YAML) auto-generated
    → openapi-typescript or orval
      → Frontend TypeScript types/client auto-generated
```
